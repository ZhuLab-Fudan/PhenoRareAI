...
tokenizer_clinicalbert = AutoTokenizer.from_pretrained("bert-base-chinese-medical-ner")

model_clinicalbert = AutoModel.from_pretrained("bert-base-chinese-medical-ner")
...
with open(path_result+"/"+"bert-base-chinese-medical-ner_feature_chpo_phenopro_core_dict.json", 'w',encoding= 'utf-8') as fp:
