import sys
import txt2hpo_rank as txt2hpo
import  pickle
...
obo_file='src/hp_20221215.obo'  #sys.argv[1]
chpo_file='src/chpo_total_202110.txt'  #sys.argv[2]
# chpo_file='src/chpo_total_onlyChinese.txt'  #sys.argv[2]
