import sys
import txt2hpo_rank_bert_base_biomedical_finetuned_ner_biomedical as txt2hpo
import pickle
...
datacohort='_bert_base_biomedical_finetuned_ner_biomedical'
# raredisease="LOPD"
...
path_bert_base_result="bert_base_chinese_finetuned_biomedical_result/finetuned_ner_biomedical_result"
...
for file in files:
    ...
    if patient_name not in patient_already_list:
        ...
        path_allgram = "."
        data_allgram = pd.read_csv(path_allgram + "/" + "bert_base_chinese_finetuned_biomedical_elements.csv")
