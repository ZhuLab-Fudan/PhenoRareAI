import sys
import txt2hpo_rank_cutoff_finetuned_ner_biomedical as txt2hpo
...
datacohort='_cutoff_finetuned_ner_biomedical'
# raredisease="LOPD"
...
path = "cutoff_result/finetuned_ner_biomedical"
os.makedirs(path)

path_csv_result="cutoff_result/finetuned_ner_biomedical"
    ...
    if patient_name not in patient_already_list:
        ...
        for i in range(0, len(given_hpos)):
            ...
            if beginid >= 0:
                ...
                # score = score_Levenshtein + score_difflib + score_rouge+score_instructor+score_chinese+score_doc2vec
                score = score_chinese
