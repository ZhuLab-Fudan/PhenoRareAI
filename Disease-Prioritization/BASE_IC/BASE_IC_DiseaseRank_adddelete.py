...
with open(path_association+"/"+"disease2hpo_adddelete.json") as fp:
    new_annotation = json.load(fp)



# ########read patient_data
path_disease = path_main + "/" + "diseaselist_adddelete"
path_patient="./HPODataBase/Hospital_DATA"


import os

path = "BASE_IC_adddelete_result"
os.makedirs(path)

path_result = "BASE_IC_adddelete_result"
