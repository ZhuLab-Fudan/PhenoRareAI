...
for ictype in ["BASE_diseaseIC"]:#,"BASE_geneIC"]:
    path_patient = "BASE_IC_result"
    ...
    with open(path_finally + "/" + ictype+"_hospital_result.json",
              'w') as fp:
    ...
    #                 patient2disease_similarity_score[patient][disease] = similarity_matrix_new[patient][disease]
    #
    # with open(path_finally + "/" + ictype+"_doccano_result.json",
    #           'w') as fp:
    #     json.dump(patient2disease_similarity_score, fp, indent=2)
