...
for ictype in ["diseaseic"]:#"diseasegeneic", "geneic","diseaseic"]:
    ...
    for insertion in ["lin"]:
        ...
        with open(path + "/" + "phen2disease_patient_" + ictype + "_hospital_" + str(insertion) + "_" + str(
                ) + "_adddelete_result.json") as fp:
            phen2disease_patient = json.load(fp)

        with open(path + "/" + "phen2disease_double_" + ictype + "_hospital_" + str(insertion) + "_" + str(
                ) + "_adddelete_result.json") as fp:
        ...
        with open(path + "/" + "phen2disease_" + ictype + "_hospital_" + str(insertion) + "_" + str(
               ) + "_integrated_sum_adddelete_result.json", 'w') as fp:
