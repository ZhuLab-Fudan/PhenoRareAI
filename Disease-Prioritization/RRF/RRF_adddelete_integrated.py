...
# "phen2disease_diseaseic_hospital_lin_integrated_sum_adddelete_result.json"
...
with open("phen2disease_diseaseic_hospital_lin_integrated_sum_adddelete_result") as fp:
    phen2disease_result = json.load(fp)

with open("Phrank_hospital_adddelete_result.json") as fp:
    phrank_result = json.load(fp)

with open("LIRICAL_hospital_adddelete_result.json") as fp:
    lirical_result = json.load(fp)

with open("BASE_diseaseIC_adddelete_hospital_result.json") as fp:
...
with open("RRF_integrated_hospital_adddelete_result.json", 'w') as fp:
